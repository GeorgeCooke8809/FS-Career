...
"""
create_day_schedule creates a schedule for a day
"""
...
@with_session
def create_day_schedule(Session, airline_icao: str, origin: str, no_flights: int, min_flight_duration: int = 0, max_flight_duration = 10_000) -> list[Route]:
    airline: Airline = (
